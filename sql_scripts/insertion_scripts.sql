...
INSERT INTO PRODUCTSPECIFICATIONREF (PRODUCTOFFERINGID,NAME,VERSION,HREF,REFERREDTYPE,CREATEDBY,CREATEDDATE,LASTUPDATEDBY,LASTUPDATEDDATE,LASTUPDATEDLOGIN)
 ...
 INSERT INTO PRODUCTOFFERING (NAME, HREF, DESCRIPTION,ISBUNDLE,LASTUPDATE,LIFECYCLESTATUS,VALIDFOR,VERSION,TYPE,BASETYPE,SCHEMALOCATION,ISSELLABLE,CREATEDBY,CREATEDDATE,LASTUPDATEDBY,LASTUPDATEDDATE,LASTUPDATEDLOGIN)
 VALUES ('Full Data Plan 7 Pounds', 'https://bt.com', 'Get full data for 7 pounds','N',sysdate(),'28 days','28 days','1','Data','Cell','UK','Y','admin',sysdate(),'admin',sysdate(),'admin');
commit;
...
INSERT INTO PRODUCTOFFERINGPRICE (PRODUCTOFFERINGID,NAME,DESCRIPTION,VALIDFOR,PRICETYPE,UNITOFMEASURE,RECURRINGCHARGEPRICE,VERSION, HREF, TYPE,BASETYPE,SCHEMALOCATION,ISBUNDLE,CREATEDBY,CREATEDDATE,LASTUPDATEDBY,LASTUPDATEDDATE,LASTUPDATEDLOGIN)
 VALUES (3,'Full Data Plan 7 Pounds Price', 'Get full data for 7 pounds','28 days','Pounds','Pounds','7 Pounds','1','https://bt.com','Data','Data','UK','N','admin',sysdate(),'admin',sysdate(),'admin');
commit;

INSERT INTO PRODUCTOFFERINGPRICE (PRODUCTOFFERINGID,NAME,DESCRIPTION,VALIDFOR,PRICETYPE,UNITOFMEASURE,RECURRINGCHARGEPRICE,VERSION, HREF, TYPE,BASETYPE,SCHEMALOCATION,ISBUNDLE,CREATEDBY,CREATEDDATE,LASTUPDATEDBY,LASTUPDATEDDATE,LASTUPDATEDLOGIN)
 VALUES (3,'Full Data Plan 7 Pounds Price', 'Get full data for 7 pounds','28 days','Pounds','Pounds','7 Pounds','1','https://bt.com','Data','Data','INDIA','N','admin',sysdate(),'admin',sysdate(),'admin');
commit;

INSERT INTO PRODUCTSPECIFICATIONREF (PRODUCTOFFERINGID,NAME,VERSION,HREF,REFERREDTYPE,CREATEDBY,CREATEDDATE,LASTUPDATEDBY,LASTUPDATEDDATE,LASTUPDATEDLOGIN)
 VALUES (3,'Full Data Plan 7 Pounds Price',1,'https://bt.com','DATA','admin',sysdate(),'admin',sysdate(),'admin');
 commit;
 
 INSERT INTO PRODUCTSPECIFICATIONREF (PRODUCTOFFERINGID,NAME,VERSION,HREF,REFERREDTYPE,CREATEDBY,CREATEDDATE,LASTUPDATEDBY,LASTUPDATEDDATE,LASTUPDATEDLOGIN)
 VALUES (3,'Full Data Plan 7 Pounds Price',1,'https://bt.com','PHONE','admin',sysdate(),'admin',sysdate(),'admin');
 commit;